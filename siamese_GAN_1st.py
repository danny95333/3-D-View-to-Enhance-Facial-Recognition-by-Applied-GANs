...
saveFile = open('/home/shumao/wyw_files/siamese_GAN_17_1/record.txt', 'w')
saveFile.write("niter:" + str(100000) + "\n")
...
parser.add_argument('--outf', default='/home/shumao/wyw_files/siamese_GAN_17_1', help='folder to output images and model checkpoints')
